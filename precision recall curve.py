# -*- coding: utf-8 -*-
"""
Created on Fri Nov 19 21:21:22 2021
...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        """
        # Add classes
        self.add_class("shapes", 1, "hair")  # 脆性区域
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("hair") != -1:
                # print "box"
                labels_form.append("hair")
...
model_path = os.path.join(MODEL_DIR, "mask_rcnn_shapes_0100.h5")  # 修改成自己训练好的模型
